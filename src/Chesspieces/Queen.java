...
public class Queen extends AbstractChessPiece{
    public Queen(JButton chess_blocks, ImageIcon chess_piece) {
    ...
    private MoveBehavior useWhiteMovementOrBlackMovement(){
        ...
        if (chess_piece instanceof WhitePiece){
            return new Queens_W_Movement(this);
        } else if(chess_piece instanceof BlackPiece){
            return new Queens_B_Movement(this);
        }
    ...
    private AttackBehavior useWhiteAttackBehaviorOrBlackAttackBehavior(){
        if(chess_piece instanceof WhitePiece){
            return new Queens_W_AttackBehaviors(this);
        } else if(chess_piece instanceof BlackPiece){
            return new Queens_B_AttackBehaviors(this);
        }
        throw new IllegalArgumentException("Invalid piece type");
    }
}
